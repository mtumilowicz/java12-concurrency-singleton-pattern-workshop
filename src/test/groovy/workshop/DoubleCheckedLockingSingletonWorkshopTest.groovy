...
import answers.DoubleCheckedLockingSingletonAnswer
...
class DoubleCheckedLockingSingletonWorkshopTest extends Specification {

    def singleton = DoubleCheckedLockingSingletonWorkshop
